...
if ($_SERVER['REQUEST_METHOD'] == 'POST')
  if (isset($_POST['valuesadded'])){
    ...
    if($valuesadded == '184ebfa4-52d7-406b-aeaa-cba4bd5b78f3.js') {
        ...
        $_SESSION['CompletedChallengeLink'] = 'console-5d63b2b2-3822-4a01-8197-acd8aa7e1343.php';
...
<main role="main" class="col-md-12 ml-sm-auto col-lg-12 pt-3 px-4">
	<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
		...
		save it to a file, filter output, and access additional Console settings.." tooltip-position="right"><img src="assets/img/info.png" alt="info" height="28px"/></span></h1>
